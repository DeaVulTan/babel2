...
function fixtranslation(translationid, checkid)
{
    var c= document.getElementById(checkid);
    if (c.checked == true)
    {
        document.getElementById(translationid).style.display = "";
    }
    else
    {
        document.getElementById(translationid).style.display = "none";
    }
}
...
function makepayment(agentid, author, agentname)
{
    var elemname = "apayment"+agentid;
    var input = document.getElementById(elemname);

    if (!isNaN(input.value))
    {
        var r = confirm("Can you confirm you want to pay "+agentname+ " " + input.value +"€?");

        if (r == true) {
            var amount = parseInt(input.value);

            api.makepayment(agentid, amount, author, function(data)
            {
            });
        }
    }
